...
export const EN: ILocales = {
  ...
  PICBED_ADVANCEDPLIST_FORMDATAKEY: 'Set FormData Key',
  PICBED_ADVANCEDPLIST_MESSAGE_FORMDATAKEY: 'Please enter the FormData key',
  PICBED_ADVANCEDPLIST_HEADERS: 'Set Headers',
  PICBED_ADVANCEDPLIST_MESSAGE_HEADERS: 'e.g. {"Content-Type": "multipart/form-data"}',
  PICBED_ADVANCEDPLIST_BODY: 'Set Body',
  PICBED_ADVANCEDPLIST_MESSAGE_BODY: 'e.g. {"key": "value"}',
  PICBED_ADVANCEDPLIST_CUSTOMPREFIX: 'Set Custom Prefix',
  PICBED_ADVANCEDPLIST_MESSAGE_CUSTOMPREFIX: 'e.g. https://example.com/',
  PICBED_ADVANCEDPLIST_WEBPATH: 'Set Web Path',
  PICBED_ADVANCEDPLIST_MESSAGE_WEBPATH: 'Used to generate URL path',
  ...
  PICBED_ALIST_UPLOADPATH: 'Set Upload Path',
  PICBED_ALIST_MESSAGE_UPLOAD_PATH: 'Ex. /test/',
  PICBED_ALIST_WEBPATH: 'Set Web Path',
  ...
  PICBED_TENCENTCLOUD_WEBPATH: 'Set Web Path',
  ...
  PICBED_TENCENTCLOUD_MESSAGE_WEBPATH: 'Used to generate URL path',
  PICBED_TENCENTCLOUD_MESSAGE_CUSTOMURL: 'Ex. https://test.com',
  ...
  PICBED_UPYUN_ANTILEECHTOKEN: 'Set Anti-Leech Token',
  PICBED_UPYUN_EXPIRETIME: 'Set Expire Time(seconds)',
  PICBED_UPYUN_MESSAGE_OPERATOR: 'Ex. me',
  PICBED_UPYUN_MESSAGE_PASSWORD: 'Ex. xxx',
  ...
  PICBED_WEBDAVPLIST_WEBPATH: 'Set Website Path',
  ...
  // sftpplist
  PICBED_SFTPPLIST: 'SFTP Built-in',
  ...
  PICBED_AWSS3PLIST_OPTIONS: 'Set Options',
  PICBED_AWSS3PLIST_MESSAGE_OPTIONS: 'Ex. ?x-oss-process=xxx',
  ...
  PICBED_AWSS3PLIST_MESSAGE_UPLOADPATH: 'Ex. test/',
