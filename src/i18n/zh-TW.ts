...
export const ZH_TW: ILocales = {
  ...
  PICBED_ADVANCEDPLIST_FORMDATAKEY: '設定表單Key',
  PICBED_ADVANCEDPLIST_MESSAGE_FORMDATAKEY: '例如: file',
  ...
  PICBED_ADVANCEDPLIST_CUSTOMPREFIX: '設定自定義前綴',
  PICBED_ADVANCEDPLIST_MESSAGE_CUSTOMPREFIX: '例如: https://example.com/',
  PICBED_ADVANCEDPLIST_WEBPATH: '設定網站路徑',
  PICBED_ADVANCEDPLIST_MESSAGE_WEBPATH: '用於網頁顯示的路徑',
  PICBED_ADVANCEDPLIST_RESDATAPATH: '設定返回數據路徑',
  PICBED_ADVANCEDPLIST_MESSAGE_RESDATAPATH: '例如: data.url',
  PICBED_ADVANCEDPLIST_UPLOADSCRIPTNAME: '設定上傳腳本名稱',
  PICBED_ADVANCEDPLIST_MESSAGE_UPLOADSCRIPTNAME: '請輸入存放在腳本目錄中的上傳腳本名稱',
  ...
  PICBED_LOCAL_MESSAGE_WEBPATH: '用於網頁顯示的路徑',
  ...
  PICBED_ALIST_UPLOADPATH: '設定上傳路徑',
  PICBED_ALIST_MESSAGE_UPLOAD_PATH: '例如: /test',
  PICBED_ALIST_WEBPATH: '設定網址路徑',
  PICBED_ALIST_MESSAGE_WEB_PATH: '用於網頁顯示的路徑',
  PICBED_ALIST_CUSTOMURL: '設定自訂網址',
  PICBED_ALIST_MESSAGE_CUSTOMURL: '例如: https://test.com',

  // Ali-cloud
  PICBED_ALICLOUD: '阿里雲OSS',
  ...
  PICBED_TENCENTCLOUD_WEBPATH: '設定網址路徑',
  ...
  PICBED_TENCENTCLOUD_MESSAGE_WEBPATH: '例如: /usr/local/images/',
  ...
  PICBED_TENCENTCLOUD_SLIM_CONFIRM: '開啟',
  ...
  PICBED_UPYUN_ANTILEECHTOKEN: '設定防盜鏈Token',
  PICBED_UPYUN_EXPIRETIME: '設定過期時間(秒)',
  PICBED_UPYUN_MESSAGE_OPERATOR: '例如: me',
  PICBED_UPYUN_MESSAGE_PASSWORD: '例如: 123456',
  ...
  PICBED_WEBDAVPLIST_WEBPATH: '設定網站路徑',
  ...
  PICBED_AWSS3PLIST_OPTIONS: '設定網址後綴',
  PICBED_AWSS3PLIST_MESSAGE_OPTIONS: '例如: ?x-oss-process=xxx',
  ...
  BUILDIN_WATERMARK_WATERMARKFONTPATH: '設定水印字體',
  BUILDIN_WATERMARK_MESSAGE_WATERMARKFONTPATH: '請輸入水印字體文件路徑',
  BUILDIN_WATERMARK_WATERMARKSCALERATIO: '設定水印圖片比例',
  BUILDIN_WATERMARK_MESSAGE_WATERMARKFONTRATIO: '請輸入0-1的數字',
  BUILDIN_WATERMARK_WATERMARKCOLOR: '設定水印字體顏色',
  ...
  BUILDIN_WATERMARK_WATERMARKIMAGEOPACITY: '設定水印圖片透明度',
  BUILDIN_WATERMARK_MESSAGE_WATERMARKIMAGEOPACITY: '請輸入0-255的整數',

  BUILDIN_SKIPPROCESS: '跳過處理設定',
  BUILDIN_SKIPPROCESS_SKIPPROCESSEXTLIST: '設定跳過處理的擴展名列表',
  ...
  BUILDIN_COMPRESS_MESSAGE_QUALITY: '請輸入1-100的整數',
  ...
  BUILDIN_COMPRESS_LONGEDGEASHEIGHT: '長邊作為高度',
  BUILDIN_COMPRESS_MESSAGE_LONGEDGEASHEIGHT: '將最長邊視為高度進行縮放',
  BUILDIN_COMPRESS_ISFLIP: '是否垂直翻轉圖片',
  BUILDIN_COMPRESS_ISFLOP: '是否水平翻轉圖片',
  BUILDIN_COMPRESS_RESIZEPERCENT: '設定縮放百分比',
  BUILDIN_COMPRESS_MESSAGE_RESIZEPERCENT: '請輸入數字',
  ...
  PLUGIN_HANDLER_PLUGIN_INSTALL_FAILED_REASON: '插件安裝失敗，失敗碼為${code}，錯誤記錄為 \n ${data}',
  ...
  PLUGIN_HANDLER_PLUGIN_UNINSTALL_FAILED_REASON: '插件卸載失敗，失敗碼為${code}，錯誤記錄為 \n ${data}',
  ...
  PLUGIN_HANDLER_PLUGIN_UPDATE_FAILED_REASON: '插件更新失敗，失敗碼為${code}，錯誤記錄為 \n ${data}',
