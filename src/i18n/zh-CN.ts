export const ZH_CN = {
  ...
  PICBED_ADVANCEDPLIST_FORMDATAKEY: '设定表单参数名',
  ...
  PICBED_ADVANCEDPLIST_CUSTOMPREFIX: '设定自定义前缀',
  PICBED_ADVANCEDPLIST_MESSAGE_CUSTOMPREFIX: '例如: https://example.com/',
  PICBED_ADVANCEDPLIST_WEBPATH: '设定网站路径',
  PICBED_ADVANCEDPLIST_MESSAGE_WEBPATH: '用于拼接网址路径',
  PICBED_ADVANCEDPLIST_RESDATAPATH: '设定返回数据URL路径',
  PICBED_ADVANCEDPLIST_MESSAGE_RESDATAPATH: '例如: data.url',
  PICBED_ADVANCEDPLIST_UPLOADSCRIPTNAME: '设定上传脚本名称',
  PICBED_ADVANCEDPLIST_MESSAGE_UPLOADSCRIPTNAME: '请输入存放在脚本目录中的上传脚本名称',
  ...
  PICBED_ALIST_UPLOADPATH: '设定上传路径',
  PICBED_ALIST_MESSAGE_UPLOAD_PATH: '例如: /test',
  PICBED_ALIST_WEBPATH: '设定网站路径',
  ...
  PICBED_TENCENTCLOUD_WEBPATH: '设定网站路径',
  ...
  PICBED_UPYUN_ANTILEECHTOKEN: '设定防盗链Token',
  PICBED_UPYUN_EXPIRETIME: '设定过期时间(秒)',
  ...
  PICBED_WEBDAVPLIST_WEBPATH: '设定网址路径',
  ...
  PICBED_AWSS3PLIST_OPTIONS: '设定网址后缀',
  ...
  BUILDIN_WATERMARK_WATERMARKFONTPATH: '设定水印字体文件路径',
  BUILDIN_WATERMARK_MESSAGE_WATERMARKFONTPATH: '请输入水印字体文件路径',
  BUILDIN_WATERMARK_WATERMARKSCALERATIO: '设定水印相对于图片的比例',
  BUILDIN_WATERMARK_MESSAGE_WATERMARKFONTRATIO: '请输入0-1的小数',
  BUILDIN_WATERMARK_WATERMARKCOLOR: '设定水印字体颜色',
  ...
  BUILDIN_WATERMARK_WATERMARKIMAGEOPACITY: '设定水印图片透明度',
  BUILDIN_WATERMARK_MESSAGE_WATERMARKIMAGEOPACITY: '请输入0-255的整数',

  BUILDIN_SKIPPROCESS: '跳过处理设置',
  BUILDIN_SKIPPROCESS_SKIPPROCESSEXTLIST: '设定跳过处理的文件后缀列表',
  ...
  BUILDIN_COMPRESS_MESSAGE_QUALITY: '请输入1-100的整数',
  ...
  BUILDIN_COMPRESS_LONGEDGEASHEIGHT: '长边作为高度',
  BUILDIN_COMPRESS_MESSAGE_LONGEDGEASHEIGHT: '将最长边视为高度进行缩放',
